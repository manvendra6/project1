    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="max-w-md w-full glass-card p-10 space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-400 font-medium">Sign in to manage your projects</p>
        </div>
        ...
        <p className="text-center text-slate-400 text-sm font-medium">
          ...
          <Link to="/signup" className="text-indigo-400 hover:text-indigo-300 font-bold underline underline-offset-4">
            Sign Up
          </Link>
        </p>
      </div>
